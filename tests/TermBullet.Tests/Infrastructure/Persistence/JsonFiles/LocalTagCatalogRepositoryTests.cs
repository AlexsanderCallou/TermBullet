...
public sealed class LocalTagCatalogRepositoryTests
{
    ...
    private static LocalTagCatalogRepository CreateRepository(TestContext context) =>
        new(context.ProjectRootPath, new SafeJsonFileStore());
